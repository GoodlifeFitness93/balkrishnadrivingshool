...
const IdCard = createLucideIcon("id-card", __iconNode$e);
const __iconNode$d = [
...
const SquareParking = createLucideIcon("square-parking", __iconNode$4);
const __iconNode$3 = [
  [
    "path",
    {
...
const TrafficCone = createLucideIcon("traffic-cone", __iconNode$2);
const __iconNode$1 = [
  [
    "path",
    {
